...
lint-py:  ## lint python with ruff
	python -m ruff check csp_chat
	python -m ruff format --check csp_chat
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix csp_chat
	python -m ruff format csp_chat
...
test:  ## run python tests
	python -m pytest -v csp_chat/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v csp_chat/tests --cov=csp_chat --cov-report term-missing --cov-report xml
